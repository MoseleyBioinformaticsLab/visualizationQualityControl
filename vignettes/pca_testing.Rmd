...
vignette: >
  ...
  %\VignetteDepends{visualizationQualityControl, ggplot2, patchwork}
---
...
```{r do_pca}
log_pca = prcomp(t(log_df), center = TRUE)
```
...
```{r test_pcs}
pc_stats = visqc_test_pca_scores(log_pca$x, sample_info, "class")
